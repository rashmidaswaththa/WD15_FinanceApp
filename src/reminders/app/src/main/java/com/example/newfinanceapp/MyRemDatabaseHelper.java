...
public class MyRemDatabaseHelper extends SQLiteOpenHelper {
    ...
    MyRemDatabaseHelper(@Nullable Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE my_Reminder (_id INTEGER PRIMARY KEY AUTOINCREMENT, Reminder_type TEXT, Reminder_amount REAL , Reminder_due_date TEXT)";
        db.execSQL(query);
    }
   ...
   void updateData(String row_id, String Rtype, String amount, String Rdate){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put("Reminder_type", Rtype);
        cv.put("Reminder_amount", amount);
