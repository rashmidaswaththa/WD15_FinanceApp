    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        left_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExpenseAddActivity.this, ExpenseMainActivity.class);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (insert) {
                    Toast.makeText(ExpenseAddActivity.this, "Inserted Successfully", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ExpenseAddActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ExpenseAddActivity.this, "", Toast.LENGTH_SHORT).show();
            }
        });
